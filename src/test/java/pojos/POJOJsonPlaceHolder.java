...
public class POJOJsonPlaceHolder {
   ...
   private String title;
    ...
    public POJOJsonPlaceHolder(String ahmet, String s, int i1, int i) {
    }
    ...
    public void POJOJsonPlaceHolder(String title, String body, int id, int userId) {
        this.title = title;
        this.body = body;
        this.id = id;
        this.userId = userId;
    ...
    public void POJOJsonPlaceHolder() {
    }
